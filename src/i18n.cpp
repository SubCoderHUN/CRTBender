...
const wchar_t* const kEnglish[static_cast<int>(Str::Count)] = {
    ...
    L"Bicubic (balanced)",
    L"Adaptive sharp (bicubic, halo-limited)",
    L"Adaptive sharpening:  %d %%",
    L"Start with Windows",
    L"Language",
    L"Undo",
    L"Reset row",
    ...
    L"0=geometry grid, 1=colour bars, 2=greyscale, 3=convergence, "
    L"4=sharpness, 5=overscan",
    L"edit left/right symmetrically",
    L"allow horizontal movement",
    L"0=bilinear, 1=bicubic, 2=adaptive sharp",
    L"adaptive sharpening amount, 0..100",
    ...
    L"Bottom left",
    L"Bottom right",
    L"Red corner correction - horizontal",
    L"Red corner correction - vertical",
    L"Blue corner correction - horizontal",
    L"Blue corner correction - vertical",
    L"Reset convergence",
    L"Corrects coloured fringes on sharp edges. Green is the reference and does "
    L"not move. Align both red and blue in the middle first, then adjust the "
    L"edges and finish with the four corners.",
...
const wchar_t* const kHungarian[static_cast<int>(Str::Count)] = {
    ...
    L"Geometriai rács",
    L"Színsávok",
    L"Szürkeárnyalatos átmenet",
    L"Konvergenciarács",
    L"Élességminta",
    L"Túlpásztázás és biztonsági terület",
    ...
    L"Adaptív éles (bikubikus + glóriagátlás)",
    L"Adaptív élesítés:  %d %%",
    L"Indulás a Windowsszal",
    L"Nyelv",
    L"Visszavonás",
    L"Sor nullázása",
    ...
    L"0=geometriai rács, 1=színsávok, 2=szürkeárnyalat, 3=konvergencia, "
    L"4=élesség, 5=túlpásztázás",
    L"bal/jobb szimmetrikus szerkesztés",
    L"vízszintes mozgatás engedélyezése",
    L"0=bilineáris, 1=bikubikus, 2=adaptív éles",
    L"adaptív élesítés erőssége, 0..100",
    ...
    L"Bal alsó",
    L"Jobb alsó",
    L"Vörös sarokkorrekció - vízszintes",
    L"Vörös sarokkorrekció - függőleges",
    L"Kék sarokkorrekció - vízszintes",
    L"Kék sarokkorrekció - függőleges",
    L"Konvergencia nullázása",
    L"A kontúrokon megjelenő színes szegélyt javítja. A zöld a viszonyítási alap, "
    L"az nem mozdul. Előbb a vöröset és a kéket is igazítsd a képernyő közepén, "
    L"utána a széleket, végül pedig a négy sarkot finomítsd.",
